...
// File ini berfungsi mengambil data jika menggunakan env local, maka mengambil data dari file config.json. Tapi, jika sudah menggunakan server/production, nantinya file config.json tidak akan dibuat di server melainkan mengambil dari consul kv
